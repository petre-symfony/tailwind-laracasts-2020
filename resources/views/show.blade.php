            ...
            <div class="lg:ml-12  lg:mr-64">
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
                        ...
                        <div class="w-8 h-8 bg-gray-700 rounded-full flex justify-center items-center">
                            <a href="" class="hover:text-gray-400">
                                <svg class="w-5 h-5 fill-current" viewBox="0 0 16 18" fill="none"><g clip-path="url(#clip0)">
                                    ...
                                    </g><defs><clipPath id="clip0"><path fill="#fff" d="M0 0h16v18H0z"/></clipPath></defs></svg>
                            </a>
                        </div>
                        <div class="w-8 h-8 bg-gray-700 rounded-full flex justify-center items-center">
                            <a href="" class="hover:text-gray-400">
